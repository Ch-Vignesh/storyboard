/**
 * FR-15.2, FR-15.3 — the one example storyboard phase 1 seeds, so the reader
 * view has a real manuscript to render.
 *
 * "The Yellow Wallpaper" by Charlotte Perkins Gilman, first published in The
 * New England Magazine in January 1892. Published in the United States before
 * 1929 and therefore in the public domain; the text is taken verbatim from
 * Project Gutenberg ebook 1952 and split into chapters and sections by hand.
 *
 * FR-15.2 forbids scraping contemporary fiction, and FR-15.3 requires every
 * seeded storyboard to be owned by the platform account and labelled an example
 * in the interface. Both are load-bearing: a platform whose pitch is trust
 * cannot be caught passing someone else's work off as its community.
 */

export const EXAMPLE_STORYBOARD = {
  ...
  source: {
    ...
    note: 'Public domain in the United States (published before 1929).',
  },
  chapters: [
    {
      title: 'The house',
